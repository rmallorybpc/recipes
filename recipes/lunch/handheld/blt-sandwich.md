...
1. Cook bacon in a skillet over medium heat until crispy, about 8 minutes. Drain on paper towels.
2. Toast bread slices.
3. Spread mayo on all four slices of toast.
4. Layer lettuce, tomato, and bacon on two slices.
5. Season tomato with salt and pepper.
6. Top with remaining toast slices, slice diagonally, and serve.
