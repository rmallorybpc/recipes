...
time_minutes: 30
servings: 4
source_url: https://www.themealdb.com/meal/53147
keywords: ["seafood", "spanish"]
---

# Summary

Arroz con gambas y calamar from TheMealDB imported into the planner collection.
...
1. Peel and devein most of the prawns (a fishmonger should be able to do this for you), keeping a few whole for decoration, if you like.
...
4. Pour in the wine and bubble for 1-2 mins, then pour in the seafood stock and 150ml water.
...
8. Uncover the pan and stir through the peeled prawns, then arrange any whole prawns on top of the rice mixture.
...
- Imported from TheMealDB (id: 53147).
