...
time_minutes: 30
servings: 4
source_url: https://www.themealdb.com/meal/53015
keywords: ["dessert", "american"]
---

# Summary

Krispy Kreme Donut from TheMealDB imported into the planner collection.
...
6. Cover and let rise until double, 50-60 minutes. (Dough is ready when indentation remains when touched.) Turn dough onto floured surface; roll around lightly to coat with flour.
7. Gently roll dough 1/2-inch thick with floured rolling pin.
8. Cut with floured doughnut cutter.
9. Cover and let rise until double, 30-40 minutes.
10. Heat vegetable oil in deep fryer to 350°.
...
15. Dip the doughnuts into creamy glaze set on rack.
16. Glaze:.
17. Heat butter until melted.
18. Remove from heat.
...
- Imported from TheMealDB (id: 53015).
