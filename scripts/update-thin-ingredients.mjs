...
const UPDATES = [
...

  {
    ...
    path: 'recipes/breakfast/baked-casserole/suggested-banana-oat-pancakes.md',
...

  {
    ...
    path: 'recipes/breakfast/bowls/suggested-greek-yogurt-parfait.md',
...

  {
    ...
    path: 'recipes/breakfast/handheld/suggested-breakfast-burritos.md',
...

  {
    ...
    path: 'recipes/breakfast/vegetarian/suggested-avocado-toast-with-egg.md',
...

  {
    ...
    path: 'recipes/dinner/baked-casserole/suggested-black-bean-enchiladas.md',
...

  {
    ...
    path: 'recipes/dinner/baked-casserole/suggested-eggplant-parmesan.md',
...

  {
    ...
    path: 'recipes/dinner/baked-casserole/suggested-spanakopita.md',
...

  {
    ...
    path: 'recipes/dinner/bowls/suggested-chicken-tikka-masala.md',
...

  {
    ...
    path: 'recipes/dinner/bowls/suggested-korean-beef-bulgogi-bowls.md',
...

  {
    ...
    path: 'recipes/dinner/bowls/suggested-roasted-vegetable-grain-bowls.md',
...

  {
    ...
    path: 'recipes/dinner/bowls/suggested-teriyaki-salmon-bowls.md',
...

  {
    ...
    path: 'recipes/dinner/bowls/suggested-thai-green-curry.md',
...

  {
    ...
    path: 'recipes/dinner/bowls/suggested-vegetable-curry.md',
...

  {
    ...
    path: 'recipes/dinner/handheld/suggested-fish-tacos-with-cabbage-slaw.md',
...

  {
    ...
    path: 'recipes/dinner/handheld/suggested-sausage-and-peppers.md',
...

  {
    ...
    path: 'recipes/dinner/handheld/suggested-shrimp-tacos-with-mango-slaw.md',
...

  {
    ...
    path: 'recipes/dinner/meat/suggested-butter-chicken.md',
...

  {
    ...
    path: 'recipes/dinner/meat/suggested-caprese-stuffed-chicken.md',
...

  {
    ...
    path: 'recipes/dinner/meat/suggested-japanese-chicken-katsu.md',
...

  {
    ...
    path: 'recipes/dinner/meat/suggested-lamb-kofta-with-tzatziki.md',
...

  {
    ...
    path: 'recipes/dinner/meat/suggested-sheet-pan-chicken-thighs-and-vegetables.md',
...

  {
    ...
    path: 'recipes/dinner/rice-or-pasta/suggested-caprese-pasta.md',
...

  {
    ...
    path: 'recipes/dinner/rice-or-pasta/suggested-chicken-pad-thai.md',
...

  {
    ...
    path: 'recipes/dinner/rice-or-pasta/suggested-dan-dan-noodles.md',
...

  {
    ...
    path: 'recipes/dinner/rice-or-pasta/suggested-fried-rice-with-egg-and-vegetables.md',
...

  {
    ...
    path: 'recipes/dinner/rice-or-pasta/suggested-garlic-butter-shrimp-with-pasta.md',
...

  {
    ...
    path: 'recipes/dinner/rice-or-pasta/suggested-one-pot-chicken-and-rice.md',
...

  {
    ...
    path: 'recipes/dinner/rice-or-pasta/suggested-shrimp-fried-rice.md',
...

  {
    ...
    path: 'recipes/dinner/seafood/suggested-baked-salmon-with-asparagus.md',
...

  {
    ...
    path: 'recipes/dinner/seafood/suggested-mediterranean-baked-cod.md',
...

  {
    ...
    path: 'recipes/dinner/soup-or-stew/suggested-black-bean-soup.md',
...

  {
    ...
    path: 'recipes/dinner/soup-or-stew/suggested-butternut-squash-soup.md',
...

  {
    ...
    path: 'recipes/dinner/soup-or-stew/suggested-clam-chowder.md',
...

  {
    ...
    path: 'recipes/dinner/soup-or-stew/suggested-dal-tadka.md',
...

  {
    ...
    path: 'recipes/dinner/soup-or-stew/suggested-miso-soup-with-tofu-and-vegetables.md',
...

  {
    ...
    path: 'recipes/dinner/soup-or-stew/suggested-vietnamese-pho.md',
...

  {
    ...
    path: 'recipes/dinner/vegetarian/suggested-aloo-gobi.md',
...

  {
    ...
    path: 'recipes/dinner/vegetarian/suggested-saag-paneer.md',
...

  {
    ...
    path: 'recipes/dinner/vegetarian/suggested-shakshuka.md',
...

  {
    ...
    path: 'recipes/dinner/vegetarian/suggested-veggie-stir-fry-with-tofu.md',
...

  {
    ...
    path: 'recipes/lunch/bowls/suggested-asian-noodle-salad.md',
...

  {
    ...
    path: 'recipes/lunch/bowls/suggested-caprese-salad-with-prosciutto.md',
...

  {
    ...
    path: 'recipes/lunch/bowls/suggested-greek-salad-with-chicken.md',
...

  {
    ...
    path: 'recipes/lunch/handheld/suggested-black-bean-tacos.md',
...

  {
    ...
    path: 'recipes/lunch/handheld/suggested-blt-sandwich.md',
...

  {
    ...
    path: 'recipes/lunch/handheld/suggested-egg-salad-sandwich.md',
...

  {
    ...
    path: 'recipes/lunch/handheld/suggested-quesadillas.md',
...

  {
    ...
    path: 'recipes/lunch/handheld/suggested-tuna-salad-sandwich.md',
...

  {
    ...
    path: 'recipes/lunch/handheld/suggested-turkey-and-avocado-wrap.md',
...

  {
    ...
    path: 'recipes/lunch/soup-or-stew/suggested-lentil-soup.md',
...
function updateIngredients(filePath, ingredients, sourceUrl) {
  ...
  if (ingredientsSectionRegex.test(content)) {
    ...
    if (yamlIngredientsRegex.test(content)) {
      ...
      console.log(`  WARN (no ingredients section found): ${filePath}`);
      return false;
    }
  }
